...
public class SafariLocation {
	...
	public SafariLocation(int id, String locationName, String description, String location, int minParticipant,
			int maxParticipant, int isActive, ObservableList<Gear> gearReq) {
	...
	public void initGearReq() {
		gearReq = FXCollections.observableArrayList();
	}
	public ObservableList<Gear> getGearReq() {
		return gearReq;
	}
	public void addGearToList(Gear g) {
		gearReq.add(g);
	}
	public void setGearReq(ObservableList<Gear> gearReq) {
		this.gearReq = gearReq;
	}
