...
public class LocationEditDialogController {
	...
	private void handleDeleteGearReq() {
		...
		if (selectedIndex >= 0) {
			...
			alert.setContentText("V�nligen markera utrustningen som du vill radera");
